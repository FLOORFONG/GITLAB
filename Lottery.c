...
void main()
{
  int WinLotteryNo[10] = {100000000000, 100000000000, 5515, 7233, 5614, 8876, 1215, 4232, 9155, 9995}; 
  float WinAmount[10] = {100000000000, 100000000000, 10000, 5000, 5000, 5000, 5000, 3000, 3000, 3000};
  int N = 10;
  int i, won; 
